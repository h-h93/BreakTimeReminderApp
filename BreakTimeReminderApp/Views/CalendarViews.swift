...
//    
//    var calendarViews = CalendarViews()
//    
...
//            weekdayView.heightAnchor.constraint(equalToConstant: 350),
//            
...
//            calendarView.heightAnchor.constraint(equalToConstant: 515),
...
//            startTimerminutehour.leadingAnchor.constraint(equalTo: weekdayView.leadingAnchor, constant: 215),
//            startTimerminutehour.trailingAnchor.constraint(equalTo: weekdayView.trailingAnchor, constant: -10),
//            
//        ])
//    }
//    
...
//        calendarView.addSubview(startTimerminutehour)
//        calendarView.addSubview(frequencyLabel)
//        
//        NSLayoutConstraint.activate([
//            // add constraints for timer picker and label
...
//            
//            // add constraints for frequency picker and label
//            frequencyLabel.topAnchor.constraint(equalTo: durationPicker.bottomAnchor, constant: 30),
//            frequencyLabel.leadingAnchor.constraint(equalTo: calendarView.leadingAnchor, constant: 10),
//            startTimerminutehour.topAnchor.constraint(equalTo: frequencyLabel.topAnchor, constant: 0),
//            startTimerminutehour.leadingAnchor.constraint(equalTo: calendarView.leadingAnchor, constant: 215),
//            startTimerminutehour.trailingAnchor.constraint(equalTo: calendarView.trailingAnchor, constant: -10),
//            
//        ])
//    }
//    
...
//        dateComponents.weekday = weekday // Monday
//        
//        // Create a trigger for every Monday at the specified time
//        let weeklyTrigger = Calendar.current.dateComponents([.weekday, .hour, .minute], from: date)
//        
